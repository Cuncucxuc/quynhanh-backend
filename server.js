...
(async () => {
  ...
  try {
    ...
    // ── Tao bang employee_profiles neu chua co ──────────────────────────
    await db.query(`
      CREATE TABLE IF NOT EXISTS employee_profiles (
        ...
        identityIssueDate VARCHAR(50) DEFAULT NULL,
        identityIssuePlace VARCHAR(200) DEFAULT NULL,
        passportNumber VARCHAR(50) DEFAULT NULL,
        taxCode VARCHAR(50) DEFAULT NULL,
        socialInsuranceNumber VARCHAR(50) DEFAULT NULL,
        ...
        probationStartDate VARCHAR(50) DEFAULT NULL,
        probationEndDate VARCHAR(50) DEFAULT NULL,
        ...
        contractEndDate VARCHAR(50) DEFAULT NULL,
        workingTimeType VARCHAR(100) DEFAULT NULL,
        baseSalary VARCHAR(50) DEFAULT NULL,
        salaryGrade VARCHAR(50) DEFAULT NULL,
        allowance VARCHAR(100) DEFAULT NULL,
        insuranceSalary VARCHAR(50) DEFAULT NULL,
        ...
        dependentCount VARCHAR(20) DEFAULT NULL,
        ...
        computerSkill VARCHAR(200) DEFAULT NULL,
        professionalSkill VARCHAR(300) DEFAULT NULL,
        fatherName VARCHAR(200) DEFAULT NULL,
        motherName VARCHAR(200) DEFAULT NULL,
        spouseName VARCHAR(200) DEFAULT NULL,
        childrenInfo VARCHAR(500) DEFAULT NULL,
        healthStatus VARCHAR(100) DEFAULT NULL,
        bloodType VARCHAR(10) DEFAULT NULL,
        height VARCHAR(20) DEFAULT NULL,
        weight VARCHAR(20) DEFAULT NULL,
        medicalNote VARCHAR(500) DEFAULT NULL,
        resumeStatus VARCHAR(100) DEFAULT NULL,
        degreeFileStatus VARCHAR(100) DEFAULT NULL,
        identityFileStatus VARCHAR(100) DEFAULT NULL,
        contractFileStatus VARCHAR(100) DEFAULT NULL,
        insuranceFileStatus VARCHAR(100) DEFAULT NULL,
        assetHandovers VARCHAR(500) DEFAULT NULL,
    ...
    `);
    console.log('Table employee_profiles ready');

    // ── Dong bo profileData tu employees sang employee_profiles ─────────
    await db.query(`
      INSERT IGNORE INTO employee_profiles (
        id, employee_id,
        dateOfBirth, placeOfBirth, nationality, ethnicity, religion, maritalStatus,
        identityNumber, identityIssueDate, identityIssuePlace, passportNumber,
        taxCode, socialInsuranceNumber,
        personalEmail, companyEmail, emergencyContactName, emergencyContactRelation,
        emergencyContactPhone, permanentAddress, temporaryAddress, currentAddress,
        province, district, ward, postalCode,
        employmentStatus, employeeType, jobTitle, jobLevel, managerName, workLocation,
        probationStartDate, probationEndDate, officialDate, contractNumber, contractType,
        contractStartDate, contractEndDate, workingTimeType,
        baseSalary, salaryGrade, allowance, insuranceSalary,
        bankName, bankBranch, bankAccountNumber, bankAccountName, paymentMethod, dependentCount,
        educationLevel, major, schoolName, graduationYear, certificate,
        foreignLanguage, computerSkill, professionalSkill,
        fatherName, motherName, spouseName, childrenInfo,
        healthStatus, bloodType, height, weight, medicalNote,
        resumeStatus, degreeFileStatus, identityFileStatus, contractFileStatus,
        insuranceFileStatus, assetHandovers, uniformSize, internalNote
      )
      SELECT
        CONCAT(e.id, '_profile'), e.id,
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.dateOfBirth')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.placeOfBirth')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.nationality')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.ethnicity')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.religion')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.maritalStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.identityNumber')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.identityIssueDate')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.identityIssuePlace')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.passportNumber')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.taxCode')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.socialInsuranceNumber')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.personalEmail')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.companyEmail')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.emergencyContactName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.emergencyContactRelation')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.emergencyContactPhone')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.permanentAddress')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.temporaryAddress')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.currentAddress')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.province')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.district')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.ward')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.postalCode')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.employmentStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.employeeType')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.jobTitle')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.jobLevel')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.managerName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.workLocation')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.probationStartDate')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.probationEndDate')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.officialDate')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.contractNumber')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.contractType')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.contractStartDate')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.contractEndDate')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.workingTimeType')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.baseSalary')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.salaryGrade')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.allowance')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.insuranceSalary')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.bankName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.bankBranch')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.bankAccountNumber')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.bankAccountName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.paymentMethod')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.dependentCount')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.educationLevel')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.major')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.schoolName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.graduationYear')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.certificate')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.foreignLanguage')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.computerSkill')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.professionalSkill')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.fatherName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.motherName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.spouseName')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.childrenInfo')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.healthStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.bloodType')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.height')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.weight')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.medicalNote')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.resumeStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.degreeFileStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.identityFileStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.contractFileStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.insuranceFileStatus')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.assetHandovers')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.uniformSize')),
        JSON_UNQUOTE(JSON_EXTRACT(e.profileData, '$.internalNote'))
      FROM employees e
      WHERE e.profileData IS NOT NULL AND e.profileData != '{}'
    `);
    console.log('Synced profileData to employee_profiles');
